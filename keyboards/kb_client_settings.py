...
quoting_None = types.InlineKeyboardButton('Очистить значение', callback_data='—')
...
end_None = types.InlineKeyboardButton('Очистить значение', callback_data='—')
...
nominal_None = types.InlineKeyboardButton('Очистить значение', callback_data='—')
...
market_None = types.InlineKeyboardButton('Очистить значение', callback_data='—')

frequency_two = types.InlineKeyboardButton('2', callback_data='2')
frequency_four = types.InlineKeyboardButton('4', callback_data='4')
frequency_six = types.InlineKeyboardButton('6', callback_data='6')
frequency_twelve = types.InlineKeyboardButton('12', callback_data='12')
frequency_None = types.InlineKeyboardButton('Очистить значение', callback_data='—')
...
days_None = types.InlineKeyboardButton('Очистить значение', callback_data='—')

yes = types.InlineKeyboardButton('Да ✅', callback_data='Да')
no = types.InlineKeyboardButton('Нет ❌', callback_data='Нет')
statys_None = types.InlineKeyboardButton('Очистить значение', callback_data='—')
...
keyboard_settings = {
    ...
    "Купон": [frequency_two, frequency_four, frequency_six, frequency_twelve, frequency_None],
    "Погашение": [days_week, days_month, days_quarter, days_term, days_year, days_more_years,  days_None],
